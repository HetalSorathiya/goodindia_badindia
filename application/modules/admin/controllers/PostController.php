<?php
    class Admin_PostController extends GTL_Action {
        ...
        public function listAction() {
			...
			//echo"<pre>";print_r($categoryArray);exit;
            /* Pagination Login */
            $itemsPerPageReviews = $this->PAGING_PER_PAGE;
            $currentPageReviews = 1;
            //PAGING_PER_PAGE
		...
		public function formAction() {			
            ...
            if (!empty($post_id)) {
				...
				$post_lgn = $data['post_lgn_id'];
				$userdata = $userModel->fetchEntryById($post_lgn);
				$usr_gcm_number=$userdata['usr_gcm_number'];
				//echo $usr_gcm_number;exit;
